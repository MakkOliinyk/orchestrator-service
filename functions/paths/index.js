...
const PACKAGING_SERVICE_PATH = 'us-central1-packaging-service.cloudfunctions.net/myApp';
const TRACING_SERVICE_PATH = 'us-central1-request-tracer.cloudfunctions.net/app'
...
const PATHS_BY_SERVICE = {
    ...
    'TRACING': TRACING_SERVICE_PATH,
};

module.exports = createPath = (serviceType) => (endRoute) => {
